...
namespace FinalProject.Service.BackgroundServices
{
    public class ImageWatermarkProcessBackgroundService : BackgroundService
    {
        ...
        private Task Consumer_Received(object sender, BasicDeliverEventArgs @event)
        {
            ...
            try
            {
                ...
                var path = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/Images", customerImageCreatedEvent.ImageName);
                ...
                img.Save("images/watermarks/" + customerImageCreatedEvent.ImageName);
